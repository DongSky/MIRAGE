...
from .LLM import LLM, ModelConfig, OPENAI, AZURE, Gemini, Qwen, LLM_input,LLM_output,Claude,VLLM,DeepSeek                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
...
class LLM_route():
    ...
    def __call__(self,
        ...
        match service_provider:
            ...
            case 'vllm':
                return VLLM(model_name, api_keys, config)
            case 'deepseek':
                return DeepSeek(model_name, api_keys, config)
            case _:
